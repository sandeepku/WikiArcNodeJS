...
<html lang="en">
<head>
    <title>Code coverage report for ./terraformer.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">./terraformer.js</span></h1>
    <h2>
        
        Statements: <span class="metric">97.25% <small>(671 / 690)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">92.61% <small>(401 / 433)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.47% <small>(82 / 85)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">97.25% <small>(671 / 690)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">./</a> &#187; terraformer.js</div>
</div>
<div class="body">
...
1423
1424
1425</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">5085</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  // Browser Global.
  <span class="missing-if-branch" title="else path not taken"" >E</span>if(typeof window === "object") {
...
&nbsp;
  ...
  */
<span class="fstat-no" title="function not covered" >  function warn() {</span>
<span class="cstat-no" title="statement not covered" >    var args = Array.prototype.slice.apply(arguments);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof console !== undefined &amp;&amp; console.warn) {</span>
<span class="cstat-no" title="statement not covered" >      console.warn.apply(console, args);</span>
    }
  }
&nbsp;
  /*
...
&nbsp;
  ...
  */
  function calculateBounds (geojson) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if(geojson.type){
      switch (geojson.type) {
        case 'Point':
...
&nbsp;
  Primitive.prototype.contains = <span class="fstat-no" title="function not covered" >function(primitive){</span>
<span class="cstat-no" title="statement not covered" >    return new Primitive(primitive).within(this);</span>
  };
&nbsp;
...
&nbsp;
    ...
    if (primitive.type === "Point") {
      <span class="missing-if-branch" title="else path not taken"" >E</span>if (this.type === "Point") {
...
&nbsp;
          <span class="missing-if-branch" title="else path not taken"" >E</span>if (this.within(linestring)) {
            return true;
          }
        }
      }
...
&nbsp;
    if (primitive.type === "Polygon") {
      ...
      if (this.type === "Polygon") {
        ...
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (primitive.coordinates.length === this.coordinates.length) {
          for (i = 0; i &lt; this.coordinates.length; i++) {
...
&nbsp;
      ...
      } else <span class="missing-if-branch" title="else path not taken"" >E</span>if (this.type === "MultiPolygon") {
        for (i = 0; i &lt; this.coordinates.length; i++) {
...
&nbsp;
    if (primitive.type === "MultiPolygon") {
      ...
      if (this.type === "Point") {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (primitive.coordinates.length) {
          for (i = 0; i &lt; primitive.coordinates.length; i++) {
...
&nbsp;
      ...
      // polygon.within(multipolygon)
        ...
        for (i = 0; i &lt; this.coordinates.length; i++) {
          <span class="missing-if-branch" title="else path not taken"" >E</span>if (primitive.coordinates[i].length === this.coordinates.length) {
...
&nbsp;
  Primitive.prototype.intersects = function(primitive) {
    ...
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (primitive.type === 'Feature') {
<span class="cstat-no" title="statement not covered" >      primitive = primitive.geometry;</span>
    }
&nbsp;
...
&nbsp;
    if (this.type === 'LineString') {
      ...
      } else <span class="missing-if-branch" title="else path not taken"" >E</span>if (primitive.type === 'MultiPolygon') {
    ...
    } else <span class="cstat-no" title="statement not covered" >if (this.type === 'Feature') {</span>
      // in the case of a Feature, use the internal primitive for intersection
<span class="cstat-no" title="statement not covered" >      var inner = new Primitive(this.geometry);</span>
<span class="cstat-no" title="statement not covered" >      return inner.intersects(primitive);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    warn("Type " + this.type + " to " + primitive.type + " intersection is not supported by intersects");</span>
...
&nbsp;
  Polygon.prototype.close = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    this.coordinates = closedPolygon(this.coordinates);</span>
  };
&nbsp;
  /*
  ...
  */
  function Feature(input){
    if(input &amp;&amp; input.type === "Feature"){
      extend(this, input);
    } else <span class="missing-if-branch" title="else path not taken"" >E</span>if(input &amp;&amp; input.type &amp;&amp; input.coordinates) {
      this.geometry = input;
    } else {
<span class="cstat-no" title="statement not covered" >      throw "Terraformer: invalid input for Terraformer.Feature";</span>
    }
&nbsp;
    this.type = "Feature";
  }
  ...
  */
  function FeatureCollection(input){
    if(input &amp;&amp; input.type === "FeatureCollection" &amp;&amp; input.features){
      extend(this, input);
    } else <span class="missing-if-branch" title="else path not taken"" >E</span>if(isArray(input)) {
      this.features = input;
    } else {
<span class="cstat-no" title="statement not covered" >      throw "Terraformer: invalid input for Terraformer.FeatureCollection";</span>
    }
&nbsp;
...
&nbsp;
  ...
  */
  function GeometryCollection(input){
    ...
    } else <span class="cstat-no" title="statement not covered" >if(input.coordinates &amp;&amp; input.type){</span>
<span class="cstat-no" title="statement not covered" >      this.type = "GeometryCollection";</span>
<span class="cstat-no" title="statement not covered" >      this.geometries = [input];</span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw "Terraformer: invalid input for Terraformer.GeometryCollection";</span>
    }
&nbsp;
...
&nbsp;
  function createCircle(center, radius, interpolate){
    ...
    var steps = interpolate || <span class="branch-1 cbranch-no" title="branch not covered" >64;</span>
    var polygon = {
      type: "Polygon",
      coordinates: [[]]
    };
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Nov 12 2013 14:46:01 GMT-0800 (PST)</div>
</div>
